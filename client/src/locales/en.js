export default {
  ...
  orders: {
    ...
    submittedOrders: 'Submitted Purchase Orders'
  },

  // Restocking
  restocking: {
    title: 'Restocking',
    description: 'Budget-aware restocking recommendations from demand forecast',
    ...
    orderPlaced: 'Order placed: {count} purchase orders created. View in Orders tab.',
